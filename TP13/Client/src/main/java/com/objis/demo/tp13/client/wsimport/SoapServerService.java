 ...
 * 
 */
@WebServiceClient(name = "SoapServerService", targetNamespace = "http://soap.tp13.demo.objis.com/", wsdlLocation = "http://localhost:8888/demosoaprest?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVERSERVICE_QNAME = new QName("http://soap.tp13.demo.objis.com/", "SoapServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/demosoaprest?wsdl");
    ...
    public SoapServer getSoapServerPort() {
        return super.getPort(new QName("http://soap.tp13.demo.objis.com/", "SoapServerPort"), SoapServer.class);
    }
    ...
    public SoapServer getSoapServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.tp13.demo.objis.com/", "SoapServerPort"), SoapServer.class, features);
    }
