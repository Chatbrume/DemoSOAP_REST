 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://teamsService.typescomplexes.demo.soap.objis.com/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://teamsService.typescomplexes.demo.soap.objis.com/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://teamsService.typescomplexes.demo.soap.objis.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://teamsService.typescomplexes.demo.soap.objis.com/", "TeamsPort"), Teams.class, features);
    }
